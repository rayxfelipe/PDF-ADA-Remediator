...
5. Only after confirmation, creates `reports/remediated/<original-name>_remediated.pdf`, re-audits it, and displays the remediation results.
...
Name canonical reports using one of these forms:
